...
// Source: github.com/cguerrero-bdev/golang-training/final-project/api/components/definition/controller (interfaces: QuestionController)
...
func (m *MockQuestionController) GetQuestionsByUserName(arg0 http.ResponseWriter, arg1 *http.Request) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetQuestionsByUserName", arg0, arg1)
}

// GetQuestionsByUserName indicates an expected call of GetQuestionsByUserName.
func (mr *MockQuestionControllerMockRecorder) GetQuestionsByUserName(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQuestionsByUserName", reflect.TypeOf((*MockQuestionController)(nil).GetQuestionsByUserName), arg0, arg1)
}
